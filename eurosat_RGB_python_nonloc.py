...
#ADDITIONALEPOCHS=xxx
#history = model.fit(ds_train, validation_data=ds_valid, epochs=ADDITIONALEPOCHS, initial_epoch=NUMEPOCHS, shuffle=True, steps_per_epoch=steps_per_epoch)
...
predicted_probabilities=model.predict(image_results)  #returns a numpy array
